module.exports = nativeDescription: "español (ES)", englishDescription: "Spanish (Spain)", translation:
  ...
  new_home:
    ...
    classroom_edition: "Clase de edición:"
    learn_to_code: "Aprende a programar:"
    teacher: "Profesor"
    student: "Estudiante"
    play_now: "Empezar ahora"
    im_a_teacher: "Yo soy profesor"
    im_a_student: "Yo soy estudiante"
    learn_more: "Leer más"
    classroom_in_a_box: "Una clase prediseñada para la enseñanza de la informática."
    codecombat_is: "CodeCombat es una plataforma para que los estudiantes aprendan informática mientras juegan a través de un juego de verdad."
    our_courses: "Nuestros cursos han sido probados especialmente para sobresalir en una clase configurada, incluso con profesores con poca o ninguna experiencia previa en programación."
    designed_with: "Diseñado teniendo en cuenta a los profesores"
    real_code: "Escritura real de código"
    from_the_first_level: "desde el primer nivel"
    getting_students: "Conseguir que los estudiantes escriban código lo más rápido posible es fundamental para el aprendizaje de la sintaxis de programación y su correcta estructura."
    educator_resources: "Recursos para educadores"
    course_guides: "y las guías del curso"
    teaching_computer_science: "La enseñanza de la informática no requiere un título costoso, ya que proporcionamos herramientas para ayudar a educadores con cualquier nivel previo."
